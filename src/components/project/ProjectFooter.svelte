...
<footer>
    <div class="footer__back">
        <picture>
            <img src={Cover ? urlFor(Cover).width(1441) :"https://source.unsplash.com/random/1440x1024"} alt="Image de couverture du prochain projet"/>
        </picture>
    </div>
    <div class="footer__front">
        <div>
            {#if Title != 'No more projects'}
            <p class="front__next">Next Project</p>
            {/if}
            <p class="front__title">{Title}</p>
            {#if Title != 'No more projects'}
                 <!-- content here -->
                 <a class="front__link" href={Slug}>
